...
local function generate_dock_icon(c, bg, fg, symbol)
    ...
    local indicator_focused =
        cairo.ImageSurface.create(cairo.Format.ARGB32, item_size, indicator_height)
    local indicator_unfocused =
        cairo.ImageSurface.create(cairo.Format.ARGB32, item_size, indicator_height)
    ...
    w:buttons(gears.table.join(
        ...
        awful.button({}, 3, function()
            ...
            local prefix = "<span font_family='icomoon' foreground='"
                .. i.color
                .. "'>"
                .. i.symbol
                .. "</span>"
...
for i = 1, #dock_pinned_classes do
    ...
    local i = class_icons[class] or class_icons["_"]
    dock_class_count[class] = dock_class_count[class] and (dock_class_count[class] + 1)
        or 0
