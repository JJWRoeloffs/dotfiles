...
-- Get theme variables
local visible_clients_color = beautiful.minimal_tasklist_visible_clients_color
    or "#1D8CD2"
...
local function update_widget()
    ...
    --local color = "#493999"
    local txt = hidden_clients_text
        .. #hidden_clients
        .. visible_clients_text
        .. #clients
    ...
    minimal_tasklist.markup = "<span foreground='"
        .. visible_clients_color
        .. "'>"
        .. visible_clients_text
        .. "</span>"
        .. vpad
