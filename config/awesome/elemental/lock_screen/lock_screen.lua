...
lock_screen_box = wibox({ visible = false, ontop = true, screen = screen.primary })
awful.placement.maximize(lock_screen_box)

lock_screen_box.bg = beautiful.lock_screen_bg
    or beautiful.exit_screen_bg
    or beautiful.wibar_bg
    or "#111111"
lock_screen_box.fg = beautiful.lock_screen_fg
...
awful.screen.connect_for_each_screen(function(s)
    if s == screen.primary then
        ...
        s.mylockscreen = helpers.screen_mask(
            s,
            beautiful.lock_screen_bg or beautiful.exit_screen_bg or x.background
        )
    end
end)
