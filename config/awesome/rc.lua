...
user = {
    ...
    email_client = "flatpak run org.mozilla.Thunderbird",
    music_client = "flatpak run com.spotify.Client",
    ...
    openweathermap_key = "1443417de2f88efc2c94189266108c2c",
    openweathermap_city_id = "2751773",
...
-- require("elemental.dasboard." .. dashboard_theme)
-- Lock screen
