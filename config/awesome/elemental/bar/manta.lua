...
volumebar_prefix.markup =
    helpers.colorize_text(volumebar_prefix.text, beautiful.prefix_fg)

-- Keyboard map indicator and switcher
keyboardlayout_prefix = wibox.widget.textbox(" ")
keyboardlayout_prefix.markup =
    helpers.colorize_text(keyboardlayout_prefix.text, beautiful.prefix_fg)
...
awful.screen.connect_for_each_screen(function(s)
    ...
    s.mytaglist =
        awful.widget.taglist(s, awful.widget.taglist.filter.all, keys.taglist_buttons)
